                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <form id="frm" action="ch08_test_process.jsp" method="post">
                                	...
                                	<h4>시작은 영소문자 a,b,c고 영소문자 8-12자리까지만 입력 받을 수 있게 설정해주세요.</h4>
                                	...
                                	<h4>비밀번호는 영대문자로 시작하고 영문 대소문자, 숫자, 특수문자 8-16로 설정해주세요.</h4>
...
function () {
	...
	var reqExpId = /^[a-z][a-z0-9]{7,15}$/;
	var regExpPw = /^[A-Z][^가-힝]{7,15}$/;
	var reqExpName = /^[가-힝]{2,5}$/;
	...
	$("#quest2").focusout(function(){
		if(!regExpQuest2.test($("#quest2").val())){
			$("#err_quest2").html("시작은 영소문자 a,b,c고 영소문자 8-12자리까지만 입력 받을 수 있게 설정해주세요.");
	...
	$("#pw").focusout(function(){
		if(!regExpPw.test($("#pw").val())){
			$("#err_pw").html("아이디는 영소문자로 시작하고 영소문자, 숫자 8-16자로 설정해주세요.");
